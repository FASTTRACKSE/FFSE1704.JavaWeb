		...
		<div class="content-header row">
			...
			<div class="content-header-right col-md-3 col-xs-12">
				<div role="group" aria-label="Button group with nested dropdown"
					...
					<a href="AddCongViec"> <span class="fa fa-plus"></span> Thêm mới
					</a>
				</div>
			</div>
		</div>
								...
								<div class="table-responsive">
									<table id="datatable"
										...
										<c:forEach var="c" items="${list}">
											<tr>
												<td>${c.id}</td>
												<td>${c.maduan.tenduan}</td>
												<td>${c.macongviec.loaicongviec}</td>
												<td>${c.tencongviec}</td>
												<td>${c.motacongviec}</td>
												<td>${c.tgianbdau}</td>
												<td>${c.tgiankthuc}</td>
												<td>${c.ma_nhan_vien.hoDem} ${c.ma_nhan_vien.ten}</td>
												<td>${c.dukienhoanthanh}</td>
												<td>${c.matrangthai.tentrangthai}</td>
											</tr>
										</c:forEach>
										<tbody>
