...
<div class="app-content content container-fluid">
	<div class="container">
		...
		<div class="content-wrapper">
			...
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-xs-12 mb-2">
					<h3 class="content-header-title mb-0">Chỉnh sửa thông tin Technical</h3>
		...
		<form:form method="post" action="/FBMS/Quan_Ly_Du_An/Edit_Save_Technical">
			<div class="form-body">
				...
				<label for="issueinput2">Mã Technical: </label>
					<form:hidden path="maTechnical" class="form-control" /><strong>${command.maTechnical}</strong>
				</div>
				<div class="form-group">
				...
				<div class="form-actions">
					...
					<button type="button" class="btn btn-warning mr-1">
						<i class="ft-x"></i><a href='<c:url value="/Quan_Ly_Du_An/List_Technical/1" />'>Cancel</a>
					</button>
