...
<div class="app-content content container-fluid">
	<div class="container">
		...
		<form:form method="post" action="/FBMS/Quan_Ly_Du_An/Submit_Delete_Framework">
			<div class="form-body">
				...
				<label for="issueinput2">Mã Framework: </label>
					<form:hidden path="maFramework" class="form-control" />
					<strong>${command.maFramework}</strong>
				</div>
				<div class="form-group">
					<label for="issueinput2">Tên Framework</label>
					<form:hidden path="tenFramework" class="form-control"/>
					<strong>${command.tenFramework}</strong>
				</div>
