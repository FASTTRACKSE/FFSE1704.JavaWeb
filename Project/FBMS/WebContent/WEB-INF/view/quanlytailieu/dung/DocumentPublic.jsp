...
<div class="app-content content container-fluid">
	<div class="content-wrapper">
		...
		<div style="text-align: center; color: red;">
			<h1><spring:message code="Tài Liệu"/></h1>
		</div>
							...
							<table class="table mb-0">
								<thead>
									<tr class="border-bottom-active border-custom-color">
										...
										<th>Mô tả</th>
										<th>Tên Phòng ban</th>
										<th><spring:message code="Phương Thức"/></th>
									</tr>
								</thead>
								<tbody>
									<c:if test="${not empty listPublicDocument}">
										<c:forEach var="document" items="${listPublicDocument}" varStatus="stt">
											<tr class="border-bottom-success border-custom-color">
												...
												<td>${document.ma_phong_ban.ten_phong_ban}</td>
												<td><a href="<c:url value="${document.file} "/>" class="btn-warning btn"> Download</a></td>
											</tr>
										</c:forEach>
									</c:if>
								</tbody>
