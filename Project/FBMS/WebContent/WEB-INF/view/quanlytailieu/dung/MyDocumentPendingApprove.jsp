	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0"><spring:message code="tailieu.dangChoPheDuyet"/></h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/home"><spring:message code="tailieu.home"/></a></li>
							<li class="breadcrumb-item active"><spring:message code="tailieu.dangChoPheDuyet"/></li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div style="text-align: center; color: red;">
			<h1><spring:message code="tailieu.dangChoPheDuyet"/></h1>
		</div>
					...
					<div class="card-body collapse in">
						<div class="table-responsive">
							<table class="table mb-0" id="table_id" >
								...
								<tbody>
									<c:if test="${not empty listMyDocumentPendingApprove}">
										<c:forEach var="document" items="${listMyDocumentPendingApprove}" varStatus="stt">
