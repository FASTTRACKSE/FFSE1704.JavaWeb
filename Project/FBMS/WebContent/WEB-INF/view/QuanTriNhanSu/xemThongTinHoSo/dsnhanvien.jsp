				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Danh sách nhân viên trong
								phòng ban</li>
						</ol>
					</div>
				</div>
									...
									<table id="datatable"
										...
										<thead>
											<tr>
												...
												<th scope="col">Tên tên nhân viên</th>
										...
										<tbody>
											<c:forEach var="sv" items="${listThongTin}">
												<tr class="table-primary">
													...
													<td><a href="/FBMS/thongTinNhanVien/${sv.maNhanVien}"><button
