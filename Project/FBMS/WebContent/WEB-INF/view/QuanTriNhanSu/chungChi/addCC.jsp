		...
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-2">
				<h3 class="content-header-title mb-0">
					<spring:message code="chungchi.QuanTriNhanSu.themmoi" />
				</h3>
					...
					<div class="breadcrumb-wrapper col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><spring:message
									code="chungchi.QuanTriNhanSu.themmoi" /></li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="main-content">
			<div class="row">
				<div class="form-group col-md-12">
					<p>
						<img src="<c:url value="/uploads/${chungChi2.anhDaiDien}"/>"
			...
			<div class="main-content">
				<div class="row">
					<form:form method="post"
						action="/FBMS/saveCC/${chungChi2.maNhanVien}"
						...
						<tr>
							<td><input class="btn btn-primary" type="submit"
								value="<spring:message
									code="chungchi.QuanTriNhanSu.luu" />" /></td>
							<td><a class="btn btn-secondary"
								href="/FBMS/ViewCC/${chungChi2.maNhanVien}"><spring:message
