...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 13, 2018 lúc 09:17 AM
...
(1, 'NV01', 'PDA1', 'NV', 'Nguyễn', 'A', 'anh1.jpg', '2018-11-14', 1, '01', '001', '00001', 'đà nẵng', 'kinh', '84', 'nơi ấy', '09053201211', 'dsdsd@gmail.com', '123456789', 'Bí Mật Nhà nước ', '2018-11-20', 1),
...
(3, 'NV03', 'PDA3', 'NV', 'Cao Lê', 'Thành', 'anh3.jpg', '1111-11-11', 1, '01', '002', '00049', 'đà nẵng', 'kinh', '84', 'Da nang', '01220202021', 'huynhdangkhoa922@gmail.com', '1010101001', 'Quảng Nam', '1111-11-21', 1),
(4, 'NV04', 'PGD', 'GD', 'Cao Lê', 'mai', 'anh4.jpg', '2018-11-15', 2, '01', '002', '00052', 'đà nẵng', 'kinh', '84', 'Da nang', '01220202021', 'huynhdangkhoa922@gmail.com', '1010101001', 'Quảng Nam', '2018-11-08', 1),
(5, 'NV05', 'PGD', 'GD', 'Cao Lê', 'Thành', 'anh5.jpg', '1333-12-01', 1, '01', '002', '00055', 'đà nẵng', 'kinh', '84', 'Da nang', '01220202021', 'ffse1704007@st.fasttrack.edu.vn', '1010101001', 'Quảng Nam', '2018-12-18', 1),
(6, 'NV06', 'PGD', 'GD', 'Cao Lê', 'Thành', 'anh6.jpg', '1333-12-01', 1, '01', '003', '00106', 'đà nẵng', 'kinh', '84', 'Da nang', '01220202021', 'ffse1704007@st.fasttrack.edu.vn', '1010101001', 'Quảng Nam', '2018-12-18', 2);
...
CREATE TABLE `minhtq_so_ngay_nghi_nhan_vien` (
  ...
  `so_ngay_nghi_con_lai` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `minhtq_so_ngay_nghi_nhan_vien` (`id`, `ma_nhan_vien`, `so_ngay_phep_nam`, `so_ngay_da_nghi`, `so_ngay_nghi_con_lai`) VALUES
(1, 'NV01', 12, 2, 10),
(2, '10019967', 12, 3, 0);
...
(1, 'NV01', 'HD1', '2018-11-07', '2018-11-30', 2),
(9, 'NV01', 'HD2', '2018-12-16', '2019-01-18', 3);
...
--
-- Đang đổ dữ liệu cho bảng `vai_tro_thanh_vien`
--
...
--
-- AUTO_INCREMENT cho bảng `vai_tro_thanh_vien`
--
ALTER TABLE `vai_tro_thanh_vien`
