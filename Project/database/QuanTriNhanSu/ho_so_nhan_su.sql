...
INSERT INTO `ho_so_nhan_su` (`id`, `ma_nhan_vien`, `ho_dem`, `ten`, `anh_dai_dien`, `nam_sinh`, `gioi_tinh`, `ThanhPho_TinhThanh`, `Quan_Huyen`, `Phuong_xa_thitran`, `que_quan`, `dan_toc`, `ma_quoc_tich`, `noi_tam_tru`, `so_dien_thoai`, `email`, `so_cmnd`, `noi_cap_cmnd`, `ngay_cap_cmnd`, `trang_thai`) VALUES
(1, 'NV01', 'Nguyễn', 'A', 'IMG_3662.JPG', '2018-11-14', 1, '01', '001', '00001', 'đà nẵng', 'kinh', '84', 'nơi ấy', '09053201211', 'dsdsd@gmail.com', '123456789', 'Bí Mật Nhà nước ', '2018-11-20', 1),
(2, 'NV02', 'Lê Trọng', 'Quân', 'chipu2.jpg', '1997-04-08', 1, '01', '002', '00037', 'Đà Nẵng', 'Kinh', '84', 'Đà Nẵng', '09899898990', 'quantrongle@gmail.com', '205666777', 'Đà Nẵng', '2010-11-01', 2),
