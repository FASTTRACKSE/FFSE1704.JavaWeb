...
import ftse1801.demo.spring.model.bean.SinhVien;
import ftse1801.demo.spring.model.dao.SinhVienDAO;
...
public class Studentscontroller {
	...
	@RequestMapping(value="listSinhVien/{page}")
	...
	public ModelAndView addSV(@ModelAttribute("sinhVien") SinhVien sinhVien,@RequestParam("file") CommonsMultipartFile file,HttpSession session )
			throws IllegalStateException, IOException{
		sinhVien.setImages(upload(file, session));
...
//	}
	...
	//tạo hàm upload
	public String upload(@RequestParam CommonsMultipartFile file,HttpSession session ) throws IllegalStateException, IOException {
