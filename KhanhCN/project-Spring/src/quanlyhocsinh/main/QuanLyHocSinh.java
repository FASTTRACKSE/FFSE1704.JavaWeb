...
public class QuanLyHocSinh {
	...
	public static void main(String[] args) {
		...
		System.out.println("                                  ");
		System.out.println("----****---THÔNG TIN SINH VIÊN VÀ MÔN HỌC ---****----");
		System.out.println("                                  ");
