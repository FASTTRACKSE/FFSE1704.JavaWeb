package ffse1704.jsfstaff.databasse;
...
public class ConnectionFactory {
	String url = "jdbc:mysql://localhost/quanlynhanvien?useUnicode=true&characterEncoding=utf-8";
	String user = "quanlynhanvien";
	String password = "quangminh112";
