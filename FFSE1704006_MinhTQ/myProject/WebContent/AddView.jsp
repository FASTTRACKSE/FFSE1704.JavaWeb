...
<body>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action="AddSevlet" method="post" enctype="multipart/form-data">
				

					<div class="wrap-input100 validate-input">
						<span class="label-input100">Mã sinh viên</span> <input
							class="input100" type="text" name="maSV"
					...
					<div class="wrap-input100 validate-input">
						<span class="label-input100">Lớp học:</span> <input
							class="input100" type="text" name="lophoc" value=""></input>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input">
						<span class="label-input100">Địa chỉ:</span> <input
							class="input100" type="text" name="diachi" value=""></input>
						<span class="focus-input100"></span>
					</div>
					<!-- <div class="wrap-input100 validate-input">
						<span class="label-input100">ảnh</span> <input
							class="input100" type="file" name="image" value=""></input>
						<span class="focus-input100"></span>
					</div> -->
