	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<div class="contact100-form-title"
				...
				<span class="contact100-form-title-1">Transfer </span>
			...
			<form class="contact100-form validate-form"
				action="TransferServlet" method="post">


				<div class="wrap-input100 validate-input">
					<span class="label-input100">Mã Account : </span> <input
						class="input100" type="text" name="maAC1" value="${ac.accountNo }"
						placeholder="nhập mã Account chuyển tiền" required> <span
						class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input">
					<span class="label-input100">Mã Account : </span> <input
						class="input100" type="text" name="maAC2" value=""
						placeholder="nhập mã Account được chuyển tiền" required> <span
						class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input">
					<span class="label-input100">Số tiền : </span> <input
						class="input100" type="text" name="sotien" value=""
						placeholder="nhập số tiền bạn muốn chuyển" required> <span
						class="focus-input100"></span>
				</div>
