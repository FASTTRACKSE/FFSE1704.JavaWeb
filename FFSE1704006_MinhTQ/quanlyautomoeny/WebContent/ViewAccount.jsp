		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="AddSavingAccount.jsp"><i
							class="fa fa-user fa-3x"></i> Add Saving Account</a></li>
					<li><a href="AddTransactionAccount.jsp"><i
							class="fa fa-user fa-3x"></i> Add Transaction Account</a></li>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											...
											<c:forEach var="ac" items="${list}">
												<tr class="odd gradeX">
													<td><c:out value="${ac.accountNo}" /></td>
													<td><c:out value="${ac.ownerName}" /></td>
													<td><c:out value="${ac.amount}" /></td>
													<td><c:out value="${ac.accountType}" /></td>
													<td><c:out value="${ac.interest}" /></td>
													<td><c:out value="${ac.term}" /></td>

													<td class="center"><a
														href="DepositServlet?id=${ac.accountNo}" title=""
														class="btn btn-primary"><i class="fa fa-edit "></i> </a> 
														
														<a href="WithdrawServlet?id=${ac.accountNo}" title=""
														class="btn btn-danger"><i class="fa fa-remove"></i> </a>
														
														<a href="TransferServlet?id=${ac.accountNo}" title=""
														class="btn btn-primary"><i class="fa fa-chevron-down"></i> </a>
														 
														 <a href="ReadTypeAccount?id=${ac.accountNo}" title=""
