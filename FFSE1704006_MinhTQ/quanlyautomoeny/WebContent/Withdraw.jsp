	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<div class="contact100-form-title"
				...
				<span class="contact100-form-title-1"> Withdraw </span>

			</div>



			<form class="contact100-form validate-form" action="WithdrawServlet"
				method="post">


				<div class="wrap-input100 validate-input">
					<span class="label-input100">Mã Account : </span> <input
						class="input100" type="text" name="maAC" value="${ac.accountNo }"
						placeholder="nhập mã Account" required> <span
						class="focus-input100"></span>
				</div>
				<input class="input100" type="text" name=""
					value="số dư :  ${ac.amount }">


				<div class="wrap-input100 validate-input">
					<span class="label-input100">Số tiền : </span> <input
						class="input100" type="text" name="sotien" value=""
						placeholder="nhập số tiền bạn muốn rút" required> <span
						class="focus-input100"></span>
				</div>
