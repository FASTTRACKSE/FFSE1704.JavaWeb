...
public class LapTrinhWedPHPMySQL implements MonHoc{
	String tenMonHoc;
	String thongTinMonHoc;
	GiangVien giangVien;

	public LapTrinhWedPHPMySQL() {
		super();
		// TODO Auto-generated constructor stub
	}

	public LapTrinhWedPHPMySQL(String tenMonHoc, String thongTinMonHoc, GiangVien giangVien) {
		super();
